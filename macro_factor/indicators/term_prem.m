...
% 读取短期限利率和IRS数据, 计算市场隐含流动性溢价
    ...
    yield = array2table(yield,'VariableNames',{'bond1y','bond3y','bond5y',...
                                        'bond7y','bond10y','bond30y',...
                                        'cdb1y','cdb3y','cdb5y','cdb7y',...
                                        'cdb10y','cdb20y','irs3m','irs1y',...
                                        'irs5y'});
    ...
    curve = table(times,irs1y_irs3m,irs5y_irs1y,...
